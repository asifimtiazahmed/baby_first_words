...
//                       zipTotal: zipTotal,
//                       zipFileName: nameOfFilesInsideZip,
//                     )
//                   : GridView.count(
//                       crossAxisCount: 2,
//                       childAspectRatio: 1,
...
//                               style: GoogleFonts.spicyRice(
//                                 textStyle:
//                                     TextStyle(color: Colors.redAccent, fontSize: 50, fontWeight: FontWeight.w400),
//                               ),
//                               textAlign: TextAlign.start),
//                         ),
//                         BigButton(
//                           useAssetImage:
//                               true, //this is telling the button to use the assets folder to load the images, it will use imageAsset widget otherwise it will use Imge.file widget
...
//                                   libraryName: 'alphabets',
//                                   assetPathFile: currentAssetFolder,
//                                 ),
//                               ),
//                             );
...
//                               MaterialPageRoute(
//                                 builder: (context) =>
//                                     SlideshowScreen(libraryName: 'animals', assetPathFile: currentAssetFolder),
//                               ),
//                             );
//                             //slide.nameOfList = 'letters';
//                           },
...
//                               MaterialPageRoute(
//                                 builder: (context) =>
//                                     SlideshowScreen(libraryName: 'objects', assetPathFile: currentAssetFolder),
//                               ),
//                             );
//                             //slide.nameOfList = 'letters';
//                           },
...
//                               MaterialPageRoute(
//                                 builder: (context) =>
//                                     SlideshowScreen(libraryName: 'numbers', assetPathFile: currentAssetFolder),
//                               ),
//                             );
//                             //slide.nameOfList = 'letters';
//                           },
...
//       }, onDone: () async {
//         //Display percentage of completion
//         print('download Percentage: ${downloaded / r.contentLength * 100} from onDONE');
//         progress = downloaded / r.contentLength;
//         //Save the file
